# `vite-plugin-fastly` React SSR Example

This example demonstrates how to use the `vite-plugin-fastly` plugin in a full-stack React server-side rendering (SSR) application. You can use it as a starting point for building Fastly Compute applications that serve both client-side assets and server-side logic with React.
